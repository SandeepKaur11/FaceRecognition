...
We can represent a Eigen Face as below :

![alt text](Demo/EigenFace.PNG?raw=true)

## Test Images Results

![alt text](Demo/ImageTested.PNG?raw=true)

## Recognition Rate Graph

![alt text](Demo/RecognitionRateGraph.PNG?raw=true)



![alt text](Demo/RecogntionRateForTestImages.PNG?raw=true)
